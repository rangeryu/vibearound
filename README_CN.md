...
最新版本：[VibeAround v0.7.6](https://github.com/jazzenchen/VibeAround/releases/tag/v0.7.6)。
...
| Windows x64 | [Setup EXE](https://github.com/jazzenchen/VibeAround/releases/download/v0.7.6/VibeAround_0.7.6_x64-setup.exe)、[MSI](https://github.com/jazzenchen/VibeAround/releases/download/v0.7.6/VibeAround_0.7.6_x64_en-US.msi) 或 [免安装 ZIP](https://github.com/jazzenchen/VibeAround/releases/download/v0.7.6/VibeAround-win-0.7.6-portable.zip) |
| Linux x64 | [AppImage](https://github.com/jazzenchen/VibeAround/releases/download/v0.7.6/VibeAround_0.7.6_amd64.AppImage) 或 [deb](https://github.com/jazzenchen/VibeAround/releases/download/v0.7.6/VibeAround_0.7.6_amd64.deb) |
