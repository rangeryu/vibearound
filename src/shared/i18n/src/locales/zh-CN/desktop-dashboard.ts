export const zhCNDesktopDashboard: Record<string, string> = {
  ...
  "No active agent session for this channel.":
    "此渠道暂无活跃 Agent 会话。",
  "Remote defaults saved.": "远程默认设置已保存。",
  "Select a remote entry.": "请选择一个远程入口。",
  "No messaging apps enabled": "没有启用的聊天工具",
  "Configured": "已配置",
  "Enabled": "已启用",
  "Disabled": "未启用",
  "Toggle channel": "切换渠道",
  ...
  "{{count}} active runtimes": "{{count}} 个活跃运行项",
  "{{count}} active": "{{count}} 个活跃",
  "{{count}} configured": "已配置 {{count}} 个",
  "{{count}} running": "{{count}} 个运行中",
  "{{count}} enabled": "已启用 {{count}} 个",
  Off: "未开启",
  "No apps enabled": "没有启用的聊天工具",
  "active sessions": "活跃会话",
  "Live updates": "实时更新",
  "Polling fallback": "轮询备用",
  "Public routes and tunnel process state.":
    "查看公开访问地址和隧道进程状态。",
  ...
  "Remote access is off until a tunnel starts.":
    "远程访问未启用，隧道启动后会显示在这里。",
  "No active agents": "没有活跃 Agent",
  "Agents appear after Launch or a messaging conversation starts.":
    "从启动页或聊天工具开始会话后，Agent 会显示在这里。",
  "No messaging apps running": "没有运行中的聊天工具",
  "Enable a messaging app in Settings to receive commands.":
    "在设置里启用聊天工具后，就可以接收消息命令。",
  "Data source": "数据来源",
  "{{count}} of 3 live": "3 路中 {{count}} 路实时",
  "{{provider}} tunnel": "{{provider}} 隧道",
  "Session {{id}}": "会话 {{id}}",
  "{{count}} subagents": "{{count}} 个子 Agent",
  Type: "类型",
  Name: "名称",
  Provider: "服务商",
  URL: "URL",
