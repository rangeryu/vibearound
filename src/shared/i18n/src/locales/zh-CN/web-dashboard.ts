export const zhCNWebDashboard: Record<string, string> = {
  ...
  "Work details": "工作详情",
  Subagents: "子 Agent",
  "Show subagents": "显示子 Agent",
  "Hide subagents": "隐藏子 Agent",
  "Expand subagents": "展开子 Agent",
  Collapse: "收起",
  "Multi-agent turn": "多 Agent 回合",
  "{{mode}} subagents": "{{mode}} 子 Agent",
  "{{mode}} turn": "{{mode}} 回合",
  "Current thread": "当前线程",
  Context: "上下文",
  Progress: "进度",
